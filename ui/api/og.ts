...
const SITE_URL = "https://bkn-gigs.info";
const DEFAULT_OG_IMAGE = `${SITE_URL}/api/og-image`;
const EVENTS_URL = "https://pub-756023fa49674586a44105ba7bf52137.r2.dev/apps/bkn-gigs/prod/public/events.json";
