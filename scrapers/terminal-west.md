# Terminal West Scraper

## Scraping Approach
- Source: AEG JSON API at `https://aegwebprod.blob.core.windows.net/json/events/211/events.json`.
...
## Category Mapping
- Terminal West is a music venue, so events default to `concerts`.
